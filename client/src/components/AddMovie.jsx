...
const AddMovie = () => {
  ...
  const handleAddMovie = () => {
    setOpen(!open);
    open ? setHidden('inline-block') : setHidden('hidden');
  };
  ...
  return (
    <div className='flex flex-col gap-1'>
      <section className={`bg-white text-black p-2 rounded-md ${hidden} text-sm 2xl:text-lg flex flex-col gap-2 max-w-xs`}>
      ...
      <main className='flex flex-col items-center w-fit'>
        <button className='bg-transparent text-4xl transition-all hover:scale-110 duration-[300ms] w-fit focus:outline-none' onClick={handleAddMovie}>
